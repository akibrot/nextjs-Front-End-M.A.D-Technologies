        ...
        <div className=' md:w-screen  flex items-center justify-center ' >
            ...
            <div className='h-[52vh] flex items-center justify-center'>
                <div className='w-[2px] h-full bg-[#F3F1E7] flex items-center justify-center relative'>
                    ...
                    <div data-aos={direction=="right"? "fade-right":"fade-left"} className={direction == "left" ? ' w-[200px] md:w-[400px] left-5 md:left-[160px] h-[150px] md:h-[300px]  absolute flex-col flex items-center justify-center' : ' w-[200px] md:w-[400px] right-5 md:right-[160px] h-[150px] md:h-[300px] flex-col absolute flex items-center justify-center'} >
